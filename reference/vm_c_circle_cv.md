...
ratios of each class in a categorical landscape in vector data format
the ratio is the patch area relative to area of the smallest
circumscribing circle of the patch

## Usage

``` r
vm_c_circle_cv(landscape, class_col)
```
...
#>   <chr> <chr> <chr> <chr>     <dbl>
#> 1 class 1     NA    circle_cv    NA
#> 2 class 2     NA    circle_cv    NA
#> 3 class 3     NA    circle_cv    NA
```
