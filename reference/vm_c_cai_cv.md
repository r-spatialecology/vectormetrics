...
the ratio of the core area and the area belonging to one class in a
categorical landscape in vector data format

## Usage

``` r
vm_c_cai_cv(landscape, class_col, edge_depth)
```
...
the returned calculated coefficient of variation of ratio of the core
area and the area of each class is in column "value", and this function
...
#>   <chr> <chr> <chr> <chr>  <dbl>
#> 1 class 1     NA    cai_cv    NA
#> 2 class 2     NA    cai_cv    NA
#> 3 class 3     NA    cai_cv    NA
```
