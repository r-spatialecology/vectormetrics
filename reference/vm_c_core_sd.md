...
patch core areas belonging to one class in a categorical landscape in
vector data format

## Usage

``` r
vm_c_core_sd(landscape, class_col, edge_depth)
```
...
the returned calculated standard deviation of core areas of each class
...
#>   <chr> <chr> <chr> <chr>   <dbl>
#> 1 class 1     NA    core_sd    NA
#> 2 class 2     NA    core_sd    NA
#> 3 class 3     NA    core_sd    NA
```
