...
of each class in relation to the landscape area in a categorical
landscape in vector data format

## Usage

``` r
vm_c_dcad(landscape, class_col, edge_depth)
```
...
#>   <chr> <chr> <chr> <chr>  <dbl>
#> 1 class 1     NA    dcad   4444.
#> 2 class 2     NA    dcad   7778.
#> 3 class 3     NA    dcad   6667.
```
