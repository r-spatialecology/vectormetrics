...
Mean cohesion across all patches in the landscape. Cohesion is the ratio
of the average distance-squared among all points in an equal-area circle
to the average distance-squared among all points in the shape. Values
...
#>   <chr>     <chr> <chr> <chr>  <dbl>
#> 1 landscape NA    NA    coh_mn 0.609
```
