...
number of disjunct core areas belonging to one class in a categorical
landscape in vector data format

## Usage

``` r
vm_c_dcore_sd(landscape, class_col, edge_depth)
```
...
#>   <chr> <chr> <chr> <chr>    <dbl>
#> 1 class 1     NA    dcore_sd    NA
#> 2 class 2     NA    dcore_sd    NA
#> 3 class 3     NA    dcore_sd    NA
```
