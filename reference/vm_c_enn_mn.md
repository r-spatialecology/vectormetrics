...
This function allows you to calculate the mean value of Euclidean
Nearest-Neighbor Distance among patches of one class in a categorical
landscape in vector data format Euclidean Nearest-Neighbor Distance
means the distance from a patch edge to the nearest neighbouring patch
belonging to the same class.

## Usage

``` r
vm_c_enn_mn(landscape, class_col)
```
...
#>   <chr> <chr> <chr> <chr>  <dbl>
#> 1 class 1     NA    enn_mn    NA
#> 2 class 2     NA    enn_mn    NA
#> 3 class 3     NA    enn_mn    NA
```
