...
the ratios of all patches belonging to one class in a categorical
landscape in vector data format

## Usage

``` r
vm_c_perarea_cv(landscape, class_col)
```
...
#>   <chr> <chr> <chr> <chr>      <dbl>
#> 1 class 1     NA    perarea_cv    NA
#> 2 class 2     NA    perarea_cv    NA
#> 3 class 3     NA    perarea_cv    NA
```
