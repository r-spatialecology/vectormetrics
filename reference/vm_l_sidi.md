...
This function allows you to calculate the Simpson's diversity index in a
categorical landscape in vector data format, Simpson's diversity index
is diversity index

## Usage

``` r
vm_l_sidi(landscape, class_col)
```
