vm_metrics <- tibble::tribble(
  ...
  "class", "landscape division index of each class", "division", "vm_c_division", "aggregation metric", "sum of squared ratios between the patch area and total landscape area",
  ...
  "landscape", "division index of the landscape", "division", "vm_l_division", "aggregation metric", "sum of squared ratios between the patch area and total landscape area",
