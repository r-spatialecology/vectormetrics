...
Patch-level metrics with close agreement: 4 unique metrics {.table
.caption-top}
...
Patch-level metrics with notable differences {.table .caption-top}
...
Class-level metrics with notable differences {.table .caption-top}
...
Landscape-level metrics with notable differences {.table .caption-top}
...
All 61 vectormetrics-exclusive metrics {.table .caption-top}
