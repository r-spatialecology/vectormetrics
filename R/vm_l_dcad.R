...
#' @param edge_depth the fixed distance to the edge of the patch (in map units).
#'   This parameter is required to ensure you explicitly consider the appropriate scale
#'   for your data and your problem.
...
vm_l_dcad <- function(landscape, edge_depth){
  ...
  area_sum <- sum(area$value)  # in hectares

  core_num <- vm_p_ncore(landscape, class_col = NULL, patch_col = NULL, edge_depth = edge_depth)
